<?php
// sales_functions.php
// Common functions for sales processing
    ...
    foreach ($date_array as $date_index => $sale_date) {
        ...
        foreach ($category_items as $category => $items) {
            ...
            if ($limit <= 0) {
                ...
                // Sort items by volume descending to optimize packing (First-Fit Decreasing algorithm)
                ...
                foreach ($items as $item) {
                    // If adding this item would exceed the limit, create a new bill
