...
if ($is_current_fy && $end_date > $today) {
    ...
    $date_warning = "<div class='alert alert-warning mb-3'>
        ...
        <strong>Note:</strong> Current Financial Year: " . date('d-M-Y', strtotime($fin_year_start)) . " to " . date('d-M-Y', strtotime($fin_year_end)) . "<br>
        End date has been limited to today (" . date('d-M-Y', strtotime($today)) . ") as future dates have no stock data.
    </div>";
}
